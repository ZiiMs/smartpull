...
import { encodeSharedRoute, decodeSharedRoute } from "@/features/planner/lib/share-codec"
...
const sampleRoute: PlannerRoute = {
  ...
  name: "AA Route",
  dungeonKey: "aa",
  pulls: [{ id: "pull_1", label: "Pull 1", color: "#ff6b6b", spawns: ["1-1", "1-2"] }],
  notes: [{ id: "note_1", text: "Hero here", position: [-20, 40] }],
  drawings: [{ id: "drawing_1", color: "#facc15", weight: 4, points: [[-20, 40], [-30, 70]] }],
